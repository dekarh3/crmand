...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.cbCreateContact = QtWidgets.QCommandLinkButton(self.frame_6)
        self.cbCreateContact.setMaximumSize(QtCore.QSize(30, 16777215))
        self.cbCreateContact.setText("")
        self.cbCreateContact.setDescription("")
        self.cbCreateContact.setObjectName("cbCreateContact")
        self.horizontalLayout_7.addWidget(self.cbCreateContact)
