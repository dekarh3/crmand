...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.clbTrashLoad = QtWidgets.QCommandLinkButton(self.frame_10)
        self.clbTrashLoad.setMaximumSize(QtCore.QSize(33, 16777215))
        self.clbTrashLoad.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbTrashLoad.setIcon(icon2)
        self.clbTrashLoad.setDescription("")
        self.clbTrashLoad.setObjectName("clbTrashLoad")
        self.verticalLayout_4.addWidget(self.clbTrashLoad)
