...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.clbCreateContact_3 = QtWidgets.QCommandLinkButton(self.frame_10)
        self.clbCreateContact_3.setMaximumSize(QtCore.QSize(33, 16777215))
        self.clbCreateContact_3.setText("")
        self.clbCreateContact_3.setIcon(icon1)
        self.clbCreateContact_3.setDescription("")
        self.clbCreateContact_3.setObjectName("clbCreateContact_3")
        self.verticalLayout_4.addWidget(self.clbCreateContact_3)
        self.clbCreateContact_4 = QtWidgets.QCommandLinkButton(self.frame_10)
        self.clbCreateContact_4.setMaximumSize(QtCore.QSize(33, 16777215))
        self.clbCreateContact_4.setText("")
        self.clbCreateContact_4.setIcon(icon1)
        self.clbCreateContact_4.setDescription("")
        self.clbCreateContact_4.setObjectName("clbCreateContact_4")
        self.verticalLayout_4.addWidget(self.clbCreateContact_4)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("toToday.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        self.chbToToday.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("sort.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        self.chbDateSort.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("ok.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbSave.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("link.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbGoURL1.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbExport.setIcon(icon7)
