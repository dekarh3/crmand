...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("link.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clbGoURL1.setIcon(icon4)
